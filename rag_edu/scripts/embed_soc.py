...
def main():
    ...
    print("Loading un-embedded social exercises...")
    with conn.cursor() as cur:
        cur.execute("SELECT id, vector_id, lop, bo_sach, de_bai, loi_giai FROM kb_social_exercises")
        rows = cur.fetchall()
